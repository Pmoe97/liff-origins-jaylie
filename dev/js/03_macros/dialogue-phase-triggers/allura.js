...
setup.allura_Conversation_Options_Phase0 = function () {
	setup.addChoices([
		...
		["I just want to get to know you better.", "Allura_StartMinigame", "reusable"],  // ✅ marked reusable
		["Nevermind.", "ReturnToParlor", "reusable"]  // ✅ marked reusable
	]);
};
...
setup.allura_Conversation_Options_Phase1 = function () {
	setup.addChoices([
		...
		["We don’t have to talk about this.", "Allura_ReturnToLight", "reusable"]  // ✅ reusable (exit option)
	]);
};
