setup.SexualActsDB = {
	...
	Oral_Penis_G_Suck: {
		...
		objectParts: ["penis"],
		canTakeVirginity: false,
		skillsRequired: { mouth: 1 },
		baseExcitement: { subject: 10, object: 15 },
		preferenceTags: ["Oral_R", "Penis"],
	...
	Boobjob_G_Tease: {
		...
		objectParts: ["penis"],
		canTakeVirginity: false,
		skillsRequired: { breast: 0 },
		baseExcitement: { subject: 5, object: 9 },
	...
	Boobjob_G: {
		...
		objectParts: ["penis"],
		canTakeVirginity: false,
		skillsRequired: { breast: 1 },
		baseExcitement: { subject: 8, object: 16 },
	...
	Footjob_Vagina_G_Tease: {
		...
		objectParts: ["vagina"],
		canTakeVirginity: false,
		skillsRequired: { foot: 0 },
		baseExcitement: { subject: 4, object: 9 },
	...
	Footjob_Vagina_G: {
		...
		objectParts: ["vagina"],
		canTakeVirginity: false,
		skillsRequired: { foot: 1 },
		baseExcitement: { subject: 6, object: 13 },
